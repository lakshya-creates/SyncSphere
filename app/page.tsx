...
const transcriptLines = [
  ...
  },
  {
    ...
    localized:
      "Main incident drill notes ki zimmedari le sakta hun aur call ke baad publish karunga.",
  },
  {
    speaker: "System",
...
const jargonGlossary = [
  ...
  {
    term: "Blast Radius",
    definition: "The scope of systems, users, or teams affected by a deployment or incident.",
  },
  {
    term: "P95 Latency",
    definition: "The response time below which 95% of requests complete.",
  },
];
